...
<em>Enabling Ultimate Ghoster will hide the <?php echo($agsdg_theme); ?> Role Editor from the dashboard. It can be accessed directly at any time by visiting:   <a href="<?php

    $roleEditorUrl = admin_url('admin.php?page=et_'.$agsdg_theme_slug.'_role_editor');
