...

{
	...
	if ($settings['ultimate_ghoster'] != 'yes' || ($pagenow == 'admin.php' && $plugin_page == 'divi_ghoster')) {
		...
		add_menu_page($agsdg_theme.' Ghoster', $agsdg_theme.' Ghoster', 'manage_options', 'divi_ghoster', 'divi_ghost_options_page');
...
function agsdg_change_theme_meta($newThemeName, $isUpdate) {
